...
MWF.xApplication.CRM.Actions.RestActions = new Class({
	...
	isManager: function(success, failure){
		this.action.invoke({"name": "isManager","async": false, "success": success,	"failure": failure});
	},
	//获取配置信息
	...
	updateAttachment: function(preview, wcrmId, wcrmModule,  formData, file, success,failure){
		this.action.invoke({"name": "updateAttachment","parameter": {"preview": preview ,"wcrmId": wcrmId , "wcrmModule" : wcrmModule}, "data": formData, "file": file, "success": success,	"failure": failure,"async": false});
	},
	...
	deleteCustomer: function(id, success, failure, async){
		this.action.invoke({"name": "deleteCustomer", "parameter": {"id": id },"success": success,"failure": failure,"async": false});
	},
	getCustomerListPageToPool: function(page, size,  filterData, success,failure, async){
		this.action.invoke({"name": "getCustomerListPageToPool","parameter": {"page": page , "size" : size }, "data": filterData, "async": async, "success": success,	"failure": failure});
	},
	...
	deleteContacts: function(id, success, failure, async){
		this.action.invoke({"name": "deleteContacts", "parameter": {"id": id },"success": success,"failure": failure,"async": false});
	},
	...
	getContactsListmydutyPage: function(page, size,  filterData, success,failure, async){
		this.action.invoke({"name": "getContactsListmydutyPage","parameter": {"page": page , "size" : size }, "data": filterData, "async": async, "success": success,	"failure": failure});
	},
	getContactsListsubPage: function(page, size,  filterData, success,failure, async){
		this.action.invoke({"name": "getContactsListsubPage","parameter": {"page": page , "size" : size }, "data": filterData, "async": async, "success": success,	"failure": failure});
	},
	getContactsListMyAndSubPage: function(page, size,  filterData, success,failure, async){
		this.action.invoke({"name": "getContactsListMyAndSubPage","parameter": {"page": page , "size" : size }, "data": filterData, "async": async, "success": success,	"failure": failure});
	},
	...
	deleteClue: function(id, success, failure, async){
		this.action.invoke({"name": "deleteClue", "parameter": {"leadsid": id },"success": success,"failure": failure,"async": false});
	},
	//StatisticAction---
	...
	countCustomerByProvince: function(data,success, failure, async){
		this.action.invoke({"name": "countCustomerByProvince","data": data,"async": false, "success": success,	"failure": failure});
	},
	...
	//address
	listProvince: function(success,failure, async){
		this.action.invoke({"name": "listProvince", "success": success,	"failure": failure, "async": false});
	},
	listCity: function(province, success,failure, async){
		this.action.invoke({"name": "listCity","parameter": {"province": province }, "success": success,"failure": failure, "async": false});
	},
	listDistrict: function(province,city, success,failure, async){
		this.action.invoke({"name": "listDistrict","parameter": {"province": province ,"city":city}, "success": success,"failure": failure, "async": false});
	},

	//InputLeadsAction
	inputLeads: function(formData, file, success,failure){
		this.action.invoke({"name": "inputLeads","data": formData, "file": file, "success": success,	"failure": failure});
	}
});
...
MWF.xApplication.CRM.PicTool = new Class({
    ...
    initPhotoHtml: function(toolSelector){
        debugger;
        var imgtoolHtml = '<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true"><div class="pswp__bg"></div><div class="pswp__scroll-wrap">'+
        ...
        jQuery(toolSelector).append(imgtoolHtml);
    },

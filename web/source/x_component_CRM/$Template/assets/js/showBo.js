...
Showbo.Msg={  
    ...
    alert:function(msg,fn1){
      this.show({buttons:{yes:'确认'},msg:msg,fn1:fn1,title:'消息'});
    },  
    confirm:function(title,msg,fn1,fn2,width){
      //fn为回调函数，参数和show方法的一致
        if(!width)width="420px";
        this.show({buttons:{yes:'确认',no:'取消'},msg:msg,title:title,fn1:fn1,fn2:fn2,width:width});
    },  

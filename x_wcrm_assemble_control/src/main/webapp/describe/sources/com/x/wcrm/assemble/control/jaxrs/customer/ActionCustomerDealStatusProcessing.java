...
import static com.x.wcrm.assemble.control.service.CustomerService.UN_MAKE_A_DEAL;
...
public class ActionCustomerDealStatusProcessing extends BaseAction {

	//	private static Logger logger = LoggerFactory.getLogger(ActionCustomerDealStatusProcessing.class);
	...
	ActionResult<Wo> execute(EffectivePerson effectivePerson, String customerid) throws Exception {
		try (EntityManagerContainer emc = EntityManagerContainerFactory.instance().create()) {
			...
			//这里其实要判断权限
			o.setDealstatus(UN_MAKE_A_DEAL);
			...
			operationRecordService.SaveOperationRecord(emc, effectivePerson, o, OperationRecordType.CHANGE_STATE.VAL(), UN_MAKE_A_DEAL);
			return result;
		}
	}
